...
@objc open class PMAlertAction: UIButton {
    ...
    @objc public convenience init(title: String?, style: PMAlertActionStyle, action: (() -> Void)? = nil){
        ...
        style == .default ? (self.setTitleColor(UIColor(red: 147/255.0, green: 222/255.0, blue: 255/255.0, alpha: 1.0), for: UIControl.State())) : (self.setTitleColor(UIColor.gray, for: UIControl.State()))
